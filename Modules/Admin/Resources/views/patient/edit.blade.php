                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input required value="{{ $patient->name }}" type="text" id="first-name" class="form-control" name="name"
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input required  value="{{ $patient->phone }}" type="number"  class="form-control" name="phone"
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input  required value="{{ $patient->email }}" type="email"  class="form-control" name="email"
