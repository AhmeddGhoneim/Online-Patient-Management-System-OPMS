                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $data['doctors'] }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $data['patients'] }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $data['appointments'] }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $data['categories'] }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
