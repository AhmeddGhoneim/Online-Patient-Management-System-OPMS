                    ...
                    <div class="row">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-9 col-9">
                                    ...
                                    <select required name="days[]" class="choices form-select" multiple="multiple">
                                                ...
                                                <option  @if(in_array('Saturday',$days)) selected @endif value="Saturday">Saturday</option>
                                                <option @if(in_array('Sunday',$days)) selected @endif  value="Sunday">Sunday</option>
                                                <option @if(in_array('Monday',$days)) selected @endif  value="Monday">Monday </option>
                                                <option @if(in_array('Tuesday',$days)) selected @endif  value="Tuesday">Tuesday</option>
                                                <option @if(in_array('Wednesday',$days)) selected @endif  value="Wednesday">Wednesday</option>
                                                <option @if(in_array('Thursday',$days)) selected @endif  value="Thursday">Thursday</option>
                                                <option @if(in_array('Friday',$days)) selected @endif  value="Friday">Friday</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input required value="{{ $doctor->from }}" type="number"  class="form-control" name="from">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input required value="{{ $doctor->to }}" type="number"  class="form-control" name="to">
