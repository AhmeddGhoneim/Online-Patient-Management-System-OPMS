...
<div class="page-heading">
   ...
   <form method="POST" action="{{ Route('doctor.blogs.update',$blog->id) }}" enctype="multipart/form-data">
       @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input  value="{{ $blog->title }}" type="text" id="first-name" class="form-control" name="title"
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-9 col-9">
                                    ...
                                    <img style="width: 100px" class="img-thumbnail image-preview" src="{{ url('/') }}/public/uploads/image_files/{{ $blog->image }}">
                                </div>
                            </div>
                        </div>
                        <div class="buttons">
