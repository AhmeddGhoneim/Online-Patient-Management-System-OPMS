                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input  required value="{{ $doctor->short_desc }}" type="text"  class="form-control" name="short_desc"
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-9 col-9">
                                    ...
                                    <img style="width: 100px" class="img-thumbnail image-preview" src="{{ $doctor->image ? url('/').'/uploads/image_files/'. $doctor->image : url('/') . '/images/doctor.png' }}">
                                </div>
                            </div>
                        </div>
