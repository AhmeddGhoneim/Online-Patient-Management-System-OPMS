	...
	<section class="ftco-section">
    	<div class="container">
    		<div class="row d-md-flex">
	    		<div class="col-md-6 ftco-animate img about-image order-md-last" style="background-image: url({{url('front/images/about.jpg')}})" >
	    		</div>
		              ...
		              <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
		              	<div>
			                <h2 class="mb-4">We Offer High Quality Services</h2>
			              	<p>We work to help people to save their time, improve efficiency and discover a truly hands-off online booking process.</p>
							  <p>The reason for making the online appointment scheduling is to help the patients and the doctor appointments in a easier way. It makes it through the computer</p>
				            </div>
		              </div>
		              ...
		              <div class="tab-pane fade" id="v-pills-mission" role="tabpanel" aria-labelledby="v-pills-mission-tab">
		                <div>
			                <h2 class="mb-4">To Accomodate All Patients</h2>
			              	<p>Our main goal is to save people’s time & Put an end to the spread of infection by reducing visits to the hospital, except when visiting a doctor only</p>
							  <p>access a website and makes an appointment, than to go to the hospital and wait for a long time in queue.</p>
		              ...
		              <div class="tab-pane fade" id="v-pills-goal" role="tabpanel" aria-labelledby="v-pills-goal-tab">
		                <div>
			                <h2 class="mb-4">Help Our Customers Needs</h2>
			              	<p>Our goal is to reduce patient visits in all Egyptian hospitals in order to preserve the health of patients as well as the health of the hospital staff, and when we succeed in achieving this</p>
							<p>we can also reduce the hospital reception staff, and thus reduce the general cost on hospital management</p>
				            </div>
		              </div>
		            </div>
		          </div>
      			...
      			<div class="about-wrap">
		            ...
		            <h2 class="mb-2">Healthcare with a personal touch</h2>
      				...
      				<div class="list-services d-flex ftco-animate">
      					...
      					<div class="text">
	      					<h3>Well Experience Doctors & Comfortable Clinics</h3>
